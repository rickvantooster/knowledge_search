...
use knowledge_search::{model::{CorpusModel, GLOB_CORPUS}, indexer::{scan_dir_par, add_dir_to_corpus_parallel, add_dir_to_corpus_parallel_joined_iter, add_dir_to_corpus_parallel_merge}};
...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("scan_dir_par", |b| b.iter(||{
        let local_corpus = Arc::new(CorpusModel::new());
